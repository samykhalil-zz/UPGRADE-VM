 ...
 * Handle the orders view
 */
class VirtuemartViewWorkorders extends VmView {
	...
	public function display($tpl = null)
	{
		...
		if ($layoutName == 'details') {
			...
			$this->order_list_link = JRoute::_('index.php?option=com_virtuemart&view=workorders&layout=list', FALSE);
			...
			if($_currentUser->guest){
				$details_url = juri::root().'index.php?option=com_virtuemart&view=workorders&layout=details&tmpl=component&order_pass=' . vRequest::getString('order_pass',false) .'&order_number='.vRequest::getString('order_number',false);
			} else {
				$details_url = juri::root().'index.php?option=com_virtuemart&view=workorders&layout=details&tmpl=component&virtuemart_order_id=' . $this->orderdetails['details']['BT']->virtuemart_order_id;
			}
