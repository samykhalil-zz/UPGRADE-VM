 ...
 * @package		VirtueMart
 */
class VirtueMartControllerNotf extends JControllerLegacy
{
...
// 		$force = true;
		...
		if(!empty($templateName)){
			$TemplateOverrideFolder = JPATH_SITE.DS."templates".DS.$templateName.DS."html".DS."com_virtuemart".DS."notf";
